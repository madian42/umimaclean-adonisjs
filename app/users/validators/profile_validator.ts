...
export const updateNameSchema = vine.compile(
  vine.object({
    name: vine
      .string()
      .trim()
...
export const updatePasswordSchema = vine.compile(
  vine.object({
...
export type UpdateNamePayload = Infer<typeof updateNameSchema>
export type UpdatePasswordPayload = Infer<typeof updatePasswordSchema>
