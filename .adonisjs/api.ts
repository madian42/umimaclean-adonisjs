...
type StaffBookingsIdInspectionGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('../app/bookings/controllers/staff_booking_controller.ts').default['inspection'], false>
}
...
type StaffBookingsShipIdIdUploadshipphotoPost = {
  request: MakeTuyauRequest<InferInput<typeof import('../app/bookings/validators/photo_validator.ts')['uploadPhotoSchema']>>
...
type StaffBookingsShipIdIdReleaseshipmodePost = {
  request: unknown
  response: MakeTuyauResponse<import('../app/bookings/controllers/staff_booking_controller.ts').default['releaseShipMode'], false>
}
type StaffBookingsIdCompleteinspectionPost = {
  request: MakeTuyauRequest<InferInput<typeof import('../app/bookings/validators/photo_validator.ts')['inspectionSchemaWithPhoto']>>
  response: MakeTuyauResponse<import('../app/bookings/controllers/staff_booking_controller.ts').default['completeInspection'], true>
}
...
type TransactionsCreatefullIdPost = {
  request: unknown
  response: MakeTuyauResponse<import('../app/transactions/controllers/transaction_controller.ts').default['createFull'], false>
}
type TransactionsIdGetHead = {
  request: unknown
  response: MakeTuyauResponse<import('../app/transactions/controllers/transaction_controller.ts').default['show'], false>
}
type TransactionCallbackPost = {
  request: unknown
  response: MakeTuyauResponse<import('../app/transactions/controllers/transaction_controller.ts').default['notification'], false>
}
type HealthGetHead = {
  request: unknown
    ...
    'bookings': {
      ':id': {
        'inspection': {
          ...
          '$get': StaffBookingsIdInspectionGetHead;
          '$head': StaffBookingsIdInspectionGetHead;
        };
        'complete-inspection': {
          '$url': {
          };
          '$post': StaffBookingsIdCompleteinspectionPost;
        };
      };
      'ship': {
        ':stage': {
  ...
  'transactions': {
    ...
    'create-full': {
      ':id': {
        ...
        '$post': TransactionsCreatefullIdPost;
      };
    };
    ':id': {
      '$url': {
      };
      '$get': TransactionsIdGetHead;
      '$head': TransactionsIdGetHead;
    };
  };
  'transaction': {
    'callback': {
...
const routes = [
  ...
  {
    params: ["id"],
    name: 'staff.bookings.inspection.show',
    path: '/staff/bookings/:id/inspection',
    method: ["GET","HEAD"],
    types: {} as StaffBookingsIdInspectionGetHead,
  },
  {
    params: ["stage","id"],
  ...
  {
    params: ["id"],
    name: 'staff.bookings.inspection',
    path: '/staff/bookings/:id/complete-inspection',
    method: ["POST"],
    types: {} as StaffBookingsIdCompleteinspectionPost,
  },
  {
    params: ["id"],
  ...
  {
    params: ["id"],
    name: 'transactions.create_full',
    path: '/transactions/create-full/:id',
    method: ["POST"],
    types: {} as TransactionsCreatefullIdPost,
  },
  {
    params: ["id"],
    ...
    method: ["GET","HEAD"],
    types: {} as TransactionsIdGetHead,
  },
  {
    params: [],
